        ...
        >
          {[...partners, ...partners, ...partners, ...partners].map((partner, index) => (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2 truncate w-full">{partner.name}</h3>
              <p className="text-sm text-gray-500 leading-relaxed italic whitespace-normal">
                {partner.description}
              </p>
            </div>
          ))}
